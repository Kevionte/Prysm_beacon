...
type BeaconBlock struct {
	...
	ProposerIndex github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v2/consensus-types/primitives.ValidatorIndex"`
