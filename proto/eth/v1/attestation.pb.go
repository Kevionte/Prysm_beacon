...
type AttestationData struct {
	...
	Index           github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.CommitteeIndex `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v1consensus-types/primitives.CommitteeIndex"`
