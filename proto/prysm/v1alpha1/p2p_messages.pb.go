...
type Status struct {
	...
	FinalizedEpoch github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=finalized_epoch,json=finalizedEpoch,proto3" json:"finalized_epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v2/consensus-types/primitives.Epoch"`
	HeadRoot       []byte                                                             `protobuf:"bytes,4,opt,name=head_root,json=headRoot,proto3" json:"head_root,omitempty" ssz-size:"32"`
	HeadSlot       github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot  `protobuf:"varint,5,opt,name=head_slot,json=headSlot,proto3" json:"head_slot,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v2/consensus-types/primitives.Slot"`
}
...
type BeaconBlocksByRangeRequest struct {
	...
	StartSlot github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=start_slot,json=startSlot,proto3" json:"start_slot,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v2/consensus-types/primitives.Slot"`
...
type ENRForkID struct {
	...
	NextForkEpoch     github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=next_fork_epoch,json=nextForkEpoch,proto3" json:"next_fork_epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v2/consensus-types/primitives.Epoch"`
}
