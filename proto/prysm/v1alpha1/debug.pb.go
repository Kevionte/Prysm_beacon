...
type BeaconStateRequest_Slot struct {
	Slot github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=slot,proto3,oneof" cast-type:"github.com/Kevionte/prysm_beacon/v2/consensus-types/primitives.Slot"`
}
