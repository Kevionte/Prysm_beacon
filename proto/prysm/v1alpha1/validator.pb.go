...
type SyncSubcommitteeIndexRequest struct {
	...
	Slot      github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot `protobuf:"varint,2,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Slot"`
}
...
type SyncCommitteeContributionRequest struct {
	...
	Slot      github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Slot"`
...
type SyncSubcommitteeIndexResponse struct {
	...
	Indices []github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.CommitteeIndex `protobuf:"varint,1,rep,packed,name=indices,proto3" json:"indices,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.CommitteeIndex"`
}
...
type ValidatorStatusResponse struct {
	...
	DepositInclusionSlot      github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot  `protobuf:"varint,3,opt,name=deposit_inclusion_slot,json=depositInclusionSlot,proto3" json:"deposit_inclusion_slot,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Slot"`
	ActivationEpoch           github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,4,opt,name=activation_epoch,json=activationEpoch,proto3" json:"activation_epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Epoch"`
...
type CommitteeSubnetsSubscribeRequest struct {
	...
	Slots        []github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot           `protobuf:"varint,1,rep,packed,name=slots,proto3" json:"slots,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Slot"`
	CommitteeIds []github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.CommitteeIndex `protobuf:"varint,2,rep,packed,name=committee_ids,json=committeeIds,proto3" json:"committee_ids,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.CommitteeIndex"`
...
type Validator struct {
	...
	ActivationEligibilityEpoch github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,5,opt,name=activation_eligibility_epoch,json=activationEligibilityEpoch,proto3" json:"activation_eligibility_epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Epoch"`
	ActivationEpoch            github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,6,opt,name=activation_epoch,json=activationEpoch,proto3" json:"activation_epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Epoch"`
	ExitEpoch                  github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,7,opt,name=exit_epoch,json=exitEpoch,proto3" json:"exit_epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Epoch"`
	WithdrawableEpoch          github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,8,opt,name=withdrawable_epoch,json=withdrawableEpoch,proto3" json:"withdrawable_epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Epoch"`
}
...
type ValidatorInfo struct {
	...
	Epoch               github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch          `protobuf:"varint,3,opt,name=epoch,proto3" json:"epoch,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Epoch"`
...
type ValidatorActivationResponse_Status struct {
	...
	Index     github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,3,opt,name=index,proto3" json:"index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.ValidatorIndex"`
}
...
type DutiesResponse_Duty struct {
	...
	Committee        []github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,rep,packed,name=committee,proto3" json:"committee,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.ValidatorIndex"`
	CommitteeIndex   github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.CommitteeIndex   `protobuf:"varint,2,opt,name=committee_index,json=committeeIndex,proto3" json:"committee_index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.CommitteeIndex"`
	...
	ValidatorIndex   github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex   `protobuf:"varint,7,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.ValidatorIndex"`
...
type PrepareBeaconProposerRequest_FeeRecipientContainer struct {
	...
	FeeRecipient   []byte                                                                      `protobuf:"bytes,1,opt,name=fee_recipient,json=feeRecipient,proto3" json:"fee_recipient,omitempty" ssz-size:"20"`
	ValidatorIndex github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.ValidatorIndex"`
}
