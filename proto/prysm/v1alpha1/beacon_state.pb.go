...
type BeaconState struct {
	...
	Slot                        github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot `protobuf:"varint,1003,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Slot"`
...
type PendingAttestation struct {
	...
	InclusionDelay  github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot           `protobuf:"varint,3,opt,name=inclusion_delay,json=inclusionDelay,proto3" json:"inclusion_delay,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.Slot"`
	ProposerIndex   github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,4,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.ValidatorIndex"`
}
...
type BeaconStateCapella struct {
	...
	NextWithdrawalValidatorIndex github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,11002,opt,name=next_withdrawal_validator_index,json=nextWithdrawalValidatorIndex,proto3" json:"next_withdrawal_validator_index,omitempty" cast-type:"github.com/Kevionte/prysm_beacon/v5/consensus-types/primitives.ValidatorIndex"`
