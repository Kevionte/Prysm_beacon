...
```sh
$ go get github.com/Kevionte/prysm_beacon/runtime/logging/logrus-prefixed-formatter
```
...
import (
	...
	prefixed "github.com/Kevionte/prysm_beacon/runtime/logging/logrus-prefixed-formatter"
)
