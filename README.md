...
[![Go Report Card](https://goreportcard.com/badge/github.com/Kevionte/prysm_beacon)](https://goreportcard.com/report/github.com/Kevionte/prysm_beacon)
...
[![GitPOAP Badge](https://public-api.gitpoap.io/v1/repo/Kevionte/prysm_beacon/badge)](https://www.gitpoap.io/gh/Kevionte/prysm_beacon)

This is the core repository for Prysm, a [Golang](https://golang.org/) implementation of the [Ethereum Consensus](https://ethereum.org/en/developers/docs/consensus-mechanisms/#proof-of-stake) [specification](https://github.com/ethereum/consensus-specs), developed by [Offchain Labs](https://www.offchainlabs.com). See the [Changelog](https://github.com/Kevionte/prysm_beacon/releases) for details of the latest releases and upcoming breaking changes.
...
* [master](https://github.com/Kevionte/prysm_beacon/tree/master): This points to the latest stable release. It is ideal for most users.
* [develop](https://github.com/Kevionte/prysm_beacon/tree/develop): This is used for development, it contains the latest PRs. Developers should base their PRs on this branch.
