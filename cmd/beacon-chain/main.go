...
import (
	...
	blockchaincmd "github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/blockchain"
	dbcommands "github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/db"
	"github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/execution"
	"github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/flags"
	jwtcommands "github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/jwt"
	"github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/storage"
	backfill "github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/sync/backfill"
	bflags "github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/sync/backfill/flags"
	"github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/sync/checkpoint"
	"github.com/Kevionte/prysm_beacon/v2/cmd/beacon-chain/sync/genesis"
	"github.com/Kevionte/prysm_beacon/v2/config/features"
	"github.com/Kevionte/prysm_beacon/v2/io/file"
	"github.com/Kevionte/prysm_beacon/v2/io/logs"
	"github.com/Kevionte/prysm_beacon/v2/monitoring/journald"
...
func main() {
	...
	app := cli.App{
		Name:  "beacon-chain",
		Usage: "this is a beacon chain implementation for Sovereign",
